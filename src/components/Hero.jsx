    ...
    <section className="top-hero">
      <div className="top-hero-inner">
        ...
        <div className="hero-actions">
          <button className="btn btn-primary" onClick={() => scrollTo('contact')}>Contact me</button>
          <button className="btn btn-primary" onClick={() => scrollTo('projects')}>My work</button>
          <button className="btn btn-primary" onClick={openCV}>My CV</button>
        </div>
